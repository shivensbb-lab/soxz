...
export default function AboutPage() {
  return (
    <div>
      {/* Hero */}
      <section className="border-b border-black/10 dark:border-white/10 py-24 px-6 text-center bg-white dark:bg-[#111111] transition-colors">
        <p className="text-xs tracking-[0.4em] text-gray-400 uppercase mb-4">Our Story</p>
        <h1 className="text-5xl sm:text-7xl font-black uppercase mb-6 text-black dark:text-white">About SOXZ</h1>
        <p className="text-gray-500 dark:text-gray-400 text-lg max-w-xl mx-auto tracking-wide">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl font-black uppercase mb-5 leading-tight text-black dark:text-white">The world&apos;s most gifted item. The least thought about.</h2>
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        ...
        <h2 className="text-4xl font-black uppercase text-center mb-16 text-black dark:text-white">The Founders</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {[
            ...
            <div key={f.name} className="border-2 border-black dark:border-white p-10">
              <div className="w-16 h-16 bg-black dark:bg-white text-white dark:text-black flex items-center justify-center font-black text-2xl mb-6">
                {f.letter}
              </div>
              <p className="text-gray-600 dark:text-gray-300 italic leading-relaxed mb-6 text-sm">&quot;{f.quote}&quot;</p>
              <p className="font-black text-base uppercase tracking-widest text-black dark:text-white">{f.name}</p>
      ...
      {/* Values */}
      <section className="bg-[#F8F6F2] dark:bg-[#111111] py-20 px-6 transition-colors">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-black uppercase text-center mb-12 text-black dark:text-white">What makes SOXZ different</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-black/10 dark:bg-white/10">
            {[
              ...
              <div key={title} className="bg-white dark:bg-[#1a1a1a] p-8">
                <h3 className="font-black text-sm uppercase tracking-widest mb-3 text-black dark:text-white">{title}</h3>
      ...
      {/* CTA */}
      <section className="py-24 px-6 text-center bg-white dark:bg-[#0f0f0f] transition-colors">
        <h2 className="text-4xl font-black uppercase mb-4 text-black dark:text-white">Ready to stand out?</h2>
        <p className="text-gray-500 mb-8 tracking-widest text-sm uppercase">never for everyone, but for you</p>
        <Link href="/shop" className="inline-flex items-center gap-2 bg-black dark:bg-white text-white dark:text-black px-10 py-4 text-xs font-black uppercase tracking-widest hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors">
